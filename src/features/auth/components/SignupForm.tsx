...
import { signInWithProvider, signup } from '../services/auth';
...
export function SignupForm({
  ...
  async function handleAppleSignUp(
    ...
    event.preventDefault();
    toast.error('Apple sign-up not implemented yet.');
  }
  ...
  return (
    ...
    >
      <FieldGroup>
        ...
        <Field data-invalid={getFieldState('fullName').invalid}>
        ...
        <Field data-invalid={getFieldState('confirmPassword').invalid}>
        ...
        <Field className='grid grid-cols-3 gap-4'>
          <Button
            variant='outline'
            type='button'
            onClick={(event) => handleAppleSignUp(event)}
          >
